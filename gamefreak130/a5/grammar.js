let petGrammar = {
    ...
    "petTypes" : ["monkey", "chimpanzee", "dog", "puppy", "raccoon", "cat", "kitten", "horse", "pony", "unicorn", "cow", "water buffalo", "pig", "boar", "llama", "giraffe", "mouse", "rat", "hamster", "guinea pig", "rabbit", "bunny", "hedgehog", "chipmunk", "skunk", "badger", "turkey", "kangaroo", "bird", "duck", "parrot", "frog", "turtle", "tortoise", "lizard", "salamander", "gecko", "snake", "dragon", "sauropod", "dinosaur", "t-rex", "dolphin", "whale", "fish", "shark", "octopus", "snail", "spider", "scorpion", "crab", "lobster", "shrimp", "squid", "otter"],
