...
document.addEventListener("DOMContentLoaded", function(){
	new Vue({
		...
		template: `<div id="app">
			...
			<p>Wow! Even without masks (and with barely any productivity when working at home), we hardly ever drop below 95% of our max production capacity, since you can't catch a cold from someone who isn't in the office!</p>
			<p>
